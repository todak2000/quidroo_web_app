    ...
    try:
        ...
        if User.objects.filter(email=email).exists():
            ...
            email = {
                ...
                'html': '<section style="background-color: #EEF1F8;height:auto;width: auto;display: flex;flex-direction: column;align-items: center;justify-content: center;"> <div style="background: #FFFFFF;width: 100%;padding: 10vh;"><img src="https://i.im.ge/2021/09/23/TCyJRy.jpg" style="margin:auto; width:30%; height: auto; margin-bottom:2rem;" /><h3 style="margin-top:-6vh;">Hello '+str(company_name)+'!</h3><p style="font-size: 1.15rem;color:#767E9F;">kindly click on the button below to activate your Quidroo Account</p> <a style="background-color: #5151E0;color: #fff; padding: 15px 25px;border: 0;font-size: 1rem;font-weight: 100;border-radius: 5px; text-decoration:none;" href="https://'+current_site.domain+'/verify/'+token+'">Click Here</a></p></div></section>',
